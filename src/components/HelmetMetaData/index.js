...
export default function HelmetMetaData(props) {
  ...
  let title = props.title !== undefined ? props.title : "Hacking Lab";
  let image =
  ...
  let hashtag = props.hashtag !== undefined ? props.hashtag : "#hackinglab";
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Hacking Lab" />
