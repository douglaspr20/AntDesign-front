...
const TermsOfUsePage = () => {
  return (<div className="term-of-use-page">
    <div className="term-of-use-page__container">
      <h1>TERMS OF USE</h1>
      ...
      <p>
        These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and HR Tech Conferences LLC ("Company", “we”, “us”, or “our”), concerning your access to and use of the https://www.hackinghrlab.io/ website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
      ...
      <p>
        ...
        If you are unsatisfied with our services, please email us at enrique@hackinghr.io or call us at 2674232002.
      </p>
      ...
      <h1>CALIFORNIA USERS AND RESIDENTS</h1>
      <p>
      ...
      <p>
        ...
        <br></br>
        HR Tech Conferences LLC
        <br></br>
        850 Beech St
        <br></br>
        Unit 405
        <br></br>
        San Diego, CA 92101-2893
        <br></br>
        United States
        <br></br>
        Phone: 2674232002
