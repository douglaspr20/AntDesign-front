    ...
    <div className="global-conference">
      ...
      <Modal
        ...
        footer={[
          <CustomButton
            text="Ok"
            onClick={() => setModalRequirementsVisible(false)}
            size="xs"
          />,
        ]}
      ...
      >
        <Timeline>
          <Timeline.Item>
            Help reviewing or selecting your sessions to build your own agenda
            (perhaps due to a vision, hearing or learning impairment)
          </Timeline.Item>
          <Timeline.Item>
            A transcript or only-audio file of the sessions (although
            autogenerated captions will be provided for all the panels during
            the conference, and for the presentations the week after the
            conference).
          </Timeline.Item>
          <p>
            Please confirm below and we will get in touch in touch with you via
            email. Thank you!
          </p>
        </Timeline>
      </Modal>
