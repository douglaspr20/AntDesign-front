...
export const getAllOfMyCohort = createAction(GET_ALL_OF_MY_COHORT, (UserId) => ({ UserId }))
const setAllOfMyCohort = createAction(SET_ALL_OF_MY_COHORT, (allOfMySkillCohorts) => ({ allOfMySkillCohorts }))
