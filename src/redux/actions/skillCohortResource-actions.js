...
export const getAllSkillCohortResources = createAction(GET_ALL_RESOURCE, (SkillCohortId, filter) => ({ SkillCohortId, filter }))
export const getSkillCohortResource = createAction(GET_RESOURCE, (id) => ({ id }))
export const setAllSkillCohortResources = createAction(SET_ALL_RESOURCE, (allSkillCohortResources) => ({ allSkillCohortResources }))
