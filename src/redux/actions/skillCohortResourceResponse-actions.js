...
const getAllResourceResponses = createAction(
	GET_ALL_RESOURCE_RESPONSES,
	(SkillCohortResourceId, SkillCohortParticipantId) => ({ SkillCohortResourceId, SkillCohortParticipantId }),
);
const getResourceResponse = createAction(GET_RESOURCE_RESPONSE, (SkillCohortResourceId, SkillCohortParticipantId) => ({
	SkillCohortResourceId,
	SkillCohortParticipantId,
}));
const setAllResourceResponse = createAction(SET_ALL_RESOURCE_RESPONSE, (allSkillCohortResourceResponses) => ({
	allSkillCohortResourceResponses,
}));
const setResourceResponse = createAction(SET_RESOURCE_RESPONSE, (skillCohortResourceResponse) => ({
	skillCohortResourceResponse,
}));
const updateResourceResponse = createAction(UPDATE_RESOURCE_RESPONSE, (SkillCohortResourceResponseId, response) => ({
