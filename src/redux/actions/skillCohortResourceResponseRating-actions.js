...
const setAllResponseRating = createAction(SET_ALL_RESPONSE_RATING, (allSkillCohortResourceResponseRatings) => ({
	allSkillCohortResourceResponseRatings,
}));
const upsertResponseRating = createAction(UPSERT_RESPONSE_RATING, (skillCohortResourceResponseRating) => ({
